...
use cairo_lang_test_runner::compile_test_prepared_db;
...
impl Compiler for TestCompiler {
    ...
    fn compile(
        ...
        let starknet = unit.components.iter().any(|component| {
            component.package.id.name == PackageName::STARKNET
                && component.package.id.source_id == SourceId::for_std()
        });
