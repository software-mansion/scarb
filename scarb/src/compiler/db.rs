...
use cairo_lang_defs::db::{DefsGroup, set_inline_macro_plugin_overrides_for_input, set_macro_plugin_overrides_for_input};
...
pub(crate) fn build_scarb_root_database(
    ...
    b.with_optimizations(
        unit.compiler_config
            .compiler_optimizations
            .to_lowering_optimizations(),
    );
            ...
            (
                ...
                CrateSettings {
                    ...
                    experimental_features: cairo_lang_filesystem::db::ExperimentalFeaturesConfig {
                        ...
                        repr_ptrs: experimental_features
                            .contains(&SmolStr::new_static("repr_ptrs"))
                    },
                },
            )
        })
