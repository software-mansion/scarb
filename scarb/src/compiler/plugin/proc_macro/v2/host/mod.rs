...
use crate::compiler::plugin::proc_macro::{InstancesDeclared, ProcMacroInstance};
...
impl InstancesDeclared for ProcMacroHostPlugin {
...
impl MacroPlugin for ProcMacroHostPlugin {
    ...
    fn declared_attributes(&self) -> Vec<String> {
        InstancesDeclared::declared_attributes(self)
    }

    fn declared_derives(&self) -> Vec<String> {
        InstancesDeclared::declared_derives(self)
    }

    fn executable_attributes(&self) -> Vec<String> {
        InstancesDeclared::executable_attributes(self)
    }
}
