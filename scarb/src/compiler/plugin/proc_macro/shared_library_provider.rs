use crate::compiler::plugin::proc_macro::compilation::PROC_MACRO_BUILD_PROFILE;
...
impl SharedLibraryProvider for Package {
    ...
    fn shared_lib_path(&self, config: &Config) -> anyhow::Result<Utf8PathBuf> {
        let lib_name =
            crate::compiler::plugin::proc_macro::compilation::get_cargo_library_name(self, config)
