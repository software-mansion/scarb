...
use crate::core::{
    Config, DepKind, DependencyVersionReq, FeatureEnabled, InliningStrategy, ManifestBuilder,
...
impl From<FeatureEnabled> for TomlFeatureToEnable {
    fn from(value: FeatureEnabled) -> Self {
...
impl TryFrom<TomlFeatureToEnable> for FeatureEnabled {
    type Error = anyhow::Error;
