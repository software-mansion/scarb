...
fn dev_dependencies() {
    ...
    PackageChecker::assert(&hello.child("target/package/hello-1.0.0.tar.zst"))
...
fn workspace() {
    ...
    WorkspaceBuilder::start()
        ...
        .dep("dev_dep", dev_dep.version("1.0.0"))
        .manifest_extra(indoc! {r#"
            [workspace.tool.fmt]
            sort-module-level-items = true
        "#})
