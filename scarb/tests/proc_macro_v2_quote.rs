...
fn can_use_quote() {
    ...
    CairoPluginProjectBuilder::default_v2()
        ...
        .lib_rs(indoc! {r##"
        use cairo_lang_macro_v2::{ProcMacroResult, TokenStream, inline_macro, quote};
        #[inline_macro]
...
fn can_use_quote_with_token_tree() {
    ...
    CairoPluginProjectBuilder::default_v2()
        .add_primitive_token_dep()
        .lib_rs(indoc! {r##"
        use cairo_lang_macro_v2::{ProcMacroResult, TokenStream, inline_macro, TokenTree, Token, TextSpan, quote};
        #[inline_macro]
        pub fn some(_token_stream: TokenStream) -> ProcMacroResult {
...
fn can_use_quote_with_syntax_node() {
    ...
    CairoPluginProjectBuilder::default_v2()
        ...
        .lib_rs(indoc! {r##"
        use cairo_lang_macro_v2::{ProcMacroResult, TokenStream, attribute_macro, quote};
...
fn can_use_quote_with_cairo_specific_syntax() {
    let temp = TempDir::new().unwrap();
    let t = temp.child("some");
    CairoPluginProjectBuilder::default_v2().add_primitive_token_dep()
        .add_dep(r#"cairo-lang-syntax = "2.9.1""#)
        .add_dep(r#"cairo-lang-parser = "2.9.1""#)
        .lib_rs(indoc! {r##"
        use cairo_lang_macro_v2::{ProcMacroResult, TokenStream, attribute_macro, quote};
...
fn can_parse_incoming_token_stream() {
    ...
    CairoPluginProjectBuilder::default_v2()
        ...
        .lib_rs(indoc! {r##"
        use cairo_lang_macro_v2::{ProcMacroResult, TokenStream, attribute_macro, quote};
        use cairo_lang_macro_v2::{TokenTree, Token, TextSpan};
        use cairo_lang_parser::utils::SimpleParserDatabase;
        use cairo_lang_syntax::node::with_db::SyntaxNodeWithDb;
        #[attribute_macro]
        pub fn some(_attr: TokenStream, token_stream: TokenStream) -> ProcMacroResult {
...
fn can_parse_with_token_interpolation() {
    ...
    CairoPluginProjectBuilder::default_v2()
        .add_primitive_token_dep()
        .lib_rs(indoc! {r##"
            use cairo_lang_macro_v2::{ProcMacroResult, TokenStream, attribute_macro, TokenTree, Token, TextSpan, quote};
            #[attribute_macro]
            pub fn some(_attr: TokenStream, _token_stream: TokenStream) -> ProcMacroResult {
