...
fn not_found() {
    ...
    Scarb::quick_snapbox()
        ...
        error: failed to lookup for `baz * (registry+file://[..])` in registry: registry+file://[..]

        Caused by:
            0: failed to lookup for `baz * (registry+file://[..])` in registry: registry+file://[..]
            1: package not found in registry: baz * (registry+file://[..])
        "#});
}
