...
fn can_execute_default_main_function_from_executable() {
    ...
    t.child("target/cairo-execute/execution1/air_private.json")
        .assert(predicates::path::exists());
    t.child("target/cairo-execute/execution1/air_public.json")
        .assert(predicates::path::exists());
    t.child("target/cairo-execute/execution1/memory.json")
        .assert(predicates::path::exists());
    t.child("target/cairo-execute/execution1/trace.json")
        .assert(predicates::path::exists());
}
...
fn can_produce_cairo_pie_output() {
    ...
    t.child("target/cairo-execute/execution1/execution.zip")
        .assert(predicates::path::exists());
}
