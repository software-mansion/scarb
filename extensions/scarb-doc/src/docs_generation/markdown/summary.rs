use super::traits::{
    generate_markdown_table_summary_for_top_level_subitems, mark_duplicated_item_with_relative_path,
};
...
pub fn generate_summary_file_content(crate_: &Crate) -> Result<(String, Vec<(String, String)>)> {
    ...
    Ok((markdown, module_item_summaries.to_owned()))
}
