...
fn can_create_profiler_trace_file() {
    ...
    Scarb::quick_snapbox()
        ...
        .success()
        .stdout_matches(indoc! {r#"
        [..]Compiling lib(hello) hello v0.1.0 ([..]Scarb.toml)
        [..]Compiling executable(hello) hello v0.1.0 ([..]Scarb.toml)
        [..]Finished `dev` profile target(s) in [..]
        [..]Executing hello
        Saving output to: target/execute/hello/execution1
...
fn no_required_sierra_for_profiler_trace_file() {
    ...
    Scarb::quick_snapbox()
        ...
        [..]Executing hello
        Saving output to: target/execute/hello/execution1
        error: Failed to write profiler trace data into a file - missing sierra code. Define a `[lib]` target in your config with `sierra = true` and try again.
        "#});
}
