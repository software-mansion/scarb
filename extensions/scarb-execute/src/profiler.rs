...
use cairo_annotations::trace_data::{
    ...
    ExecutionTarget as ProfilerExecutionTarget, TraceEntry as ProfilerTraceEntry,
};
use cairo_lang_executable::executable::NOT_RETURNING_HEADER_SIZE;
...
pub fn build_profiler_call_trace(
    ...
    let cairo_execution_info = CairoExecutionInfo {
        ...
        execute_target: Some(match target {
            ExecutionTarget::Bootloader => ProfilerExecutionTarget::Bootloader,
            ExecutionTarget::Standalone => ProfilerExecutionTarget::Standalone,
        }),
        not_returning_header_size: Some(NOT_RETURNING_HEADER_SIZE),
