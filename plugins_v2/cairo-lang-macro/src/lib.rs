...
pub use cairo_lang_macro_attributes_v2::*;
...
use cairo_lang_macro_stable_v2::ffi::StableSlice;
...
pub unsafe extern "C" fn expand(
    ...
    stable_attr: cairo_lang_macro_stable_v2::StableTokenStream,
    stable_token_stream: cairo_lang_macro_stable_v2::StableTokenStream,
) -> cairo_lang_macro_stable_v2::StableResultWrapper {
