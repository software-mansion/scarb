...
pub fn attribute_macro(args: TokenStream, input: TokenStream) -> TokenStream {
    macro_helper(
        ...
        quote!(::cairo_lang_macro_v2::ExpansionKind::Attr),
        quote!(::cairo_lang_macro_v2::ExpansionFunc::Attr),
    )
}
...
pub fn inline_macro(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    macro_helper(
        input,
        Default::default(),
        quote!(::cairo_lang_macro_v2::ExpansionKind::Inline),
        quote!(::cairo_lang_macro_v2::ExpansionFunc::Other),
    )
}
...
pub fn derive_macro(args: TokenStream, input: TokenStream) -> TokenStream {
    macro_helper(
        input,
        parse_macro_input!(args as AttributeArgs),
        quote!(::cairo_lang_macro_v2::ExpansionKind::Derive),
        quote!(::cairo_lang_macro_v2::ExpansionFunc::Other),
    )
}
...
fn macro_helper(
    ...
    let expanded = quote! {
        ...
        #[::cairo_lang_macro_v2::linkme::distributed_slice(::cairo_lang_macro_v2::MACRO_DEFINITIONS_SLICE)]
        #[linkme(crate = ::cairo_lang_macro_v2::linkme)]
        static #callback_link: ::cairo_lang_macro_v2::ExpansionDefinition =
            ::cairo_lang_macro_v2::ExpansionDefinition{
                name: #expansion_name,
                doc: #doc,
                kind: #kind,
                fun: #func(#item_name),
...
pub fn post_process(_args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        #[::cairo_lang_macro_v2::linkme::distributed_slice(::cairo_lang_macro_v2::AUX_DATA_CALLBACKS)]
        #[linkme(crate = ::cairo_lang_macro_v2::linkme)]
        static #callback_link: fn(::cairo_lang_macro_v2::PostProcessContext) = #item_name;
    };
    ...
    let expanded = quote! {
        ...
        static #callback_link: ::cairo_lang_macro_v2::ExpansionDefinition =
            ::cairo_lang_macro_v2::ExpansionDefinition{
                name: #item_name,
                doc: "",
                kind: ::cairo_lang_macro_v2::ExpansionKind::Attr,
                fun: ::cairo_lang_macro_v2::ExpansionFunc::Attr(::cairo_lang_macro_v2::no_op_attr),
            };
    };
    TokenStream::from(expanded)
}
