...
const ICON_FILL = "fill-blue-100 dark:fill-darksea-80 opacity-20";
const ICON_STROKE = "stroke-blue-100 dark:stroke-darksea-40";
...
const features: FeatureProps[] = [
  {
    ...
    title: "Compile",
    desc: "Comes with built-in Cairo and StarkNet compiler, no need for setting up extra tooling.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    title: "Install",
    desc: "Add, update and remove dependencies from the growing family of Cairo packages.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
