...
Example url for an item in a workspace package named `hello_world` with a relative path `src/lib.cairo`, line anchor start `10`, end `15`, and `REMOTE_BASE_URL` like above, will be:
