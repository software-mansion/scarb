...
(analogue to the [cairo](./manifest#cairo) section of the manifest definition).
...
```toml copy
[profile.dev.cairo]
sierra-replace-ids = true       # Replace all names in generated Sierra code with dummy counterparts
```
