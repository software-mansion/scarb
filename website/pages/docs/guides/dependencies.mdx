...
Now, run `scarb fetch{:shell}`, and Scarb will fetch new dependencies and all of their dependencies.
...
Then you can compile your package with all of the packages included:
