...
For example, the [`alexandria_math`](https://github.com/keep-starknet-strange/alexandria) package is hosted on GitHub, and we 'll clone its repository using Git.
...
```text filename="Output"
   Compiling alexandria_math v0.1.0 (/path/to/package/alexandria/math/Scarb.toml)
