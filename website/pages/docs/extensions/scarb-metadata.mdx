...
<BigLink
  href="https://crates.io/crates/scarb-metadata"
  text="Go to scarb-metadata on crates.io"
/>

<BigLink
  href="https://docs.rs/scarb-metadata"
  text="Go to scarb-metadata documentation on docs.rs"
/>
