...
## 0.6.0
- Expansion results now carry a spanned `cairo_lang_macro::TokenStream` instead of a flat string
  plus optional code mappings. Callers compute code mappings from the token spans themselves.
