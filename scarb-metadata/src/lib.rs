...
impl Metadata {
    ...
    /// Checks if the plugin associated with [`CompilationUnitCairoPluginMetadata`] is built-in into the compiler.
    pub fn is_builtin(&self, plugin: &CompilationUnitCairoPluginMetadata) -> Option<bool> {
